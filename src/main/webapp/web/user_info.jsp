        ...
        <form id="user_info">
	        <div class="rs_content">
	            ...
	            <div class="rs_content_username">
	                ...
	                <input name="username" class="ed_username" value="${user.username}" style="display: none;"/>
	            ...
	            <div class="rs_content_mail">
	                ...
	                <input name="email" class="ed_email" value="${user.email}" style="display: none;"/>
	                <span class="rs_mail">${user.email}</span>
	                <span class="same_click change_mail">更改邮箱</span>
	            </div>
	            <!--保存按钮-->
	            <div class="save">
	                <a href="#" class="button" id="change_info" style="color: white;">保存更改</a>
	            </div>
	        </div>
		</form>
    </div>
