...
public class Address implements Serializable{
	...
	private static final long serialVersionUID = -2809718865945723016L;
	...
	public Address(Integer uid, String recvName, String recvProvince, String recvCity, String recvArea,
			String recvAddress, String recvDistrict, String recvPhone) {
		super();
		this.uid = uid;
	...
	public Address(Integer id, Integer uid, String recvName, String recvProvince, String recvCity, String recvArea,
			String recvAddress, String recvDistrict, String recvPhone, String recvTel, String recvZip, String tag,
	...
	public String toString() {
		return "Address [id=" + id + ", uid=" + uid + ", recvName=" + recvName + ", recvProvince=" + recvProvince
				...
				+ ", recvDistrict=" + recvDistrict + ", recvPhone=" + recvPhone + ", recvTel=" + recvTel + ", recvZip="
